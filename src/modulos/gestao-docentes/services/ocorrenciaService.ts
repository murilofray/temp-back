  ...
  async update(ocorrencia: Ocorrencia, id: number) {
    try {
      ...
      if (!ocorrenciaExiste) {
        ...
        /*if(ocorrencia.abonoId){
                    const ocorrencias = await prisma.ocorrencia.findMany({
                        where: {
                            abonoId: ocorrencia.abonoId,
                        },
                    })
                }*/
        ...
        const updateOcorrencia = await prisma.ocorrencia.update({
          ...
          data: {
            abonoId: ocorrencia.abonoId,
            aprovadoPor: ocorrencia.aprovadoPor,
            status: ocorrencia.status,
            descricao: ocorrencia.descricao,
            dataOcorrencia: ocorrencia.dataOcorrencia,
            lancadoPor: ocorrencia.lancadoPor,
            servidorId: ocorrencia.servidorId,
            documentoScanId: ocorrencia.documentoScanId,
